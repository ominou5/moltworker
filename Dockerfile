...
# Install OpenClaw (CLI is still named clawdbot for backwards compatibility)
# Updated to 2026.2.3 for native Cloudflare AI Gateway support
# Build cache bust: 2026-02-05-v1-ai-gateway
